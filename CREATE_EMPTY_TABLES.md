# Supabase SQL Editor - Empty Tables Creation Script

Supabase SQL Editor mein copy aur paste karke run karne ke liye yeh complete Markdown / SQL guide hai. 
Is script se saare **Empty Tables (0 products, 0 categories, 0 banners)** create honge aur Admin login setup ho jayega.

---

## 📌 Instructions / Kaise Use Karein:

1. Apne **[Supabase Dashboard](https://supabase.com/dashboard)** par jayein.
2. Apna Project select karein (`shafiioaxfvtjfahumvv`).
3. Left side bar me **SQL Editor** (`>_` icon) par click karein.
4. **+ New Query** par click karein.
5. Niche diya gaya poora **SQL Script** copy karke paste karein aur **RUN** button dabayein.

---

## 💻 SQL Query (Empty Tables Creation Script)

```sql
-- =========================================================
-- CHETAK FASHION - CREATE EMPTY TABLES & SETUP DATABASE
-- =========================================================

-- 0. Purane Existing Tables Drop karein (Naya Fresh Setup)
...
-- 12. DEFAULT ADMIN CREDENTIALS (Email: admin@chetakfashion.com / Password: admin123)
